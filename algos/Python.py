...
class DataStructures(Algorithms):
    ...
    class StrKeyDict(collections.UserDict):
        """
        Dictionary that coerces non-string keys into strings
        """
    ...
    class BloomFilter:
        ...
        def __init__(self, capacity, error=0.005):
            ...
            self.num_hashes = int(self.num_bits * math.log(2) / float(capacity))
        ...
        def union(bloom_a, bloom_b):
            ...
            bloom_union = DataStructures.BloomFilter(bloom_a.capacity, bloom_a.error)
